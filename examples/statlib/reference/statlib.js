 ...
 * stands in for "the codebase you are about to rewrite". Plain JavaScript on
 * purpose — the classic rewrite candidate — which also lets the register
 * hook wrap it without a build step. The recorded corpus in ../corpus.js
 * drives this boundary; the port in ../port must match it.
 */
